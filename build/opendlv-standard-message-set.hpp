...
#ifndef OPENDLV_LOGIC_PERCEPTION_CONEPOSITION_HPP
#define OPENDLV_LOGIC_PERCEPTION_CONEPOSITION_HPP
...
namespace opendlv { namespace logic { namespace perception {
using namespace std::string_literals; // NOLINT
class LIB_API ConePosition {
    private:
        static constexpr const char* TheShortName = "ConePosition";
        static constexpr const char* TheLongName = "opendlv.logic.perception.ConePosition";
    ...
    public:
        ConePosition() = default;
        ConePosition(const ConePosition&) = default;
        ConePosition& operator=(const ConePosition&) = default;
        ConePosition(ConePosition&&) = default;
        ConePosition& operator=(ConePosition&&) = default;
        ~ConePosition() = default;

    public:
        inline ConePosition& color(const uint32_t &v) noexcept {
            m_color = v;
            return *this;
        }
        inline uint32_t color() const noexcept {
            return m_color;
        }
        inline ConePosition& x(const std::string &v) noexcept {
            m_x = v;
            return *this;
        }
        inline std::string x() const noexcept {
            return m_x;
        }
        inline ConePosition& y(const std::string &v) noexcept {
            m_y = v;
            return *this;
        }
        inline std::string y() const noexcept {
            return m_y;
        }
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            if (1 == fieldId) {
                doVisit(1, std::move("uint32_t"s), std::move("color"s), m_color, visitor);
                return;
            }
            if (2 == fieldId) {
                doVisit(2, std::move("std::string"s), std::move("x"s), m_x, visitor);
                return;
            }
            if (3 == fieldId) {
                doVisit(3, std::move("std::string"s), std::move("y"s), m_y, visitor);
                return;
            }
//            visitor.postVisit();
        }
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            (void)visit; // Prevent warnings from empty messages.
            std::forward<PreVisitor>(preVisit)(ID(), ShortName(), LongName());
            doTripletForwardVisit(1, std::move("uint32_t"s), std::move("color"s), m_color, preVisit, visit, postVisit);
            doTripletForwardVisit(2, std::move("std::string"s), std::move("x"s), m_x, preVisit, visit, postVisit);
            doTripletForwardVisit(3, std::move("std::string"s), std::move("y"s), m_y, preVisit, visit, postVisit);
            std::forward<PostVisitor>(postVisit)();
        }

    private:
        uint32_t m_color{ 0 }; // field identifier = 1.
        std::string m_x{ ""s }; // field identifier = 2.
        std::string m_y{ ""s }; // field identifier = 3.
};
}}}

template<>
struct isVisitable<opendlv::logic::perception::ConePosition> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<opendlv::logic::perception::ConePosition> {
    static const bool value = true;
};
#endif
...
#ifndef OPENDLV_LOGIC_PERCEPTION_KIWIPOSITION_HPP
#define OPENDLV_LOGIC_PERCEPTION_KIWIPOSITION_HPP
...
namespace opendlv { namespace logic { namespace perception {
using namespace std::string_literals; // NOLINT
class LIB_API KiwiPosition {
    private:
        static constexpr const char* TheShortName = "KiwiPosition";
        static constexpr const char* TheLongName = "opendlv.logic.perception.KiwiPosition";
    ...
    public:
        KiwiPosition() = default;
        KiwiPosition(const KiwiPosition&) = default;
        KiwiPosition& operator=(const KiwiPosition&) = default;
        KiwiPosition(KiwiPosition&&) = default;
        KiwiPosition& operator=(KiwiPosition&&) = default;
        ~KiwiPosition() = default;

    public:
        inline KiwiPosition& x(const int32_t &v) noexcept {
            m_x = v;
            return *this;
        }
        inline int32_t x() const noexcept {
            return m_x;
        }
        inline KiwiPosition& y(const int32_t &v) noexcept {
            m_y = v;
            return *this;
        }
        inline int32_t y() const noexcept {
            return m_y;
        }
...
//            visitor.preVisit(ID(), ShortName(), LongName());
            if (1 == fieldId) {
                doVisit(1, std::move("int32_t"s), std::move("x"s), m_x, visitor);
                return;
            }
            if (2 == fieldId) {
                doVisit(2, std::move("int32_t"s), std::move("y"s), m_y, visitor);
                return;
            }
//            visitor.postVisit();
        }
        ...
        inline void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            (void)visit; // Prevent warnings from empty messages.
            std::forward<PreVisitor>(preVisit)(ID(), ShortName(), LongName());
            doTripletForwardVisit(1, std::move("int32_t"s), std::move("x"s), m_x, preVisit, visit, postVisit);
            doTripletForwardVisit(2, std::move("int32_t"s), std::move("y"s), m_y, preVisit, visit, postVisit);
            std::forward<PostVisitor>(postVisit)();
        }

    private:
        int32_t m_x{ 0 }; // field identifier = 1.
        int32_t m_y{ 0 }; // field identifier = 2.
};
}}}

template<>
struct isVisitable<opendlv::logic::perception::KiwiPosition> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<opendlv::logic::perception::KiwiPosition> {
    static const bool value = true;
};
#endif
